    ...
    @testset "skiprows" begin
        for alg in [:serial, :singlebuffer, :doublebuffer]
            @testset "$alg string" begin
                ...
                @test testctx.results[2].cols[1].elements[1] == Parsers.PosLen(2, 0)
                @test testctx.results[2].cols[2].elements[1] == Parsers.PosLen(6, 0)
                @test testctx.results[3].cols[1].elements[1] == Parsers.PosLen(2, 0)
                @test testctx.results[3].cols[2].elements[1] == Parsers.PosLen(6, 0)
    ...
    @testset "No header, no schema" begin
        for alg in [:serial, :singlebuffer, :doublebuffer]
            @testset "$alg" begin
                ...
                @test testctx.schema == [String, String]
                @test testctx.results[1].cols[1].elements[1:2] == [Parsers.PosLen(1, 0), Parsers.PosLen(5, 0)]
                @test testctx.results[1].cols[2].elements[1:2] == [Parsers.PosLen(3, 0), Parsers.PosLen(7, 0)]
                @test length(testctx.results[1].cols[1]) == 2
                @test length(testctx.results[1].cols[2]) == 2
                ...
                @test testctx.header == [:COL_1, :COL_2]
                @test testctx.schema == [String, String]
                @test testctx.results[1].cols[1].elements[1:2] == [Parsers.PosLen(9, 0), Parsers.PosLen(13, 0)]
                @test testctx.results[1].cols[2].elements[1:2] == [Parsers.PosLen(11, 0), Parsers.PosLen(15, 0)]
                @test length(testctx.results[1].cols[1]) == 2
                @test length(testctx.results[1].cols[2]) == 2
            end
        end
