@precompile_setup begin
    ...
    @precompile_all_calls begin
        ...
        ChunkedCSV.parse_file(IOBuffer(PRECOMPILE_DATA), [Int,Float64,Date,DateTime,Bool,String,String,FixedDecimal{Int64,8}], ChunkedCSV.SkipContext(), _force=:parallel, nworkers=2, buffersize=64)
        ...
        ChunkedCSV.parse_file(IOBuffer(PRECOMPILE_DATA), [Int,Float64,Date,GuessDateTime,Bool,String,String,Int], ChunkedCSV.SkipContext(), _force=:parallel, nworkers=2, buffersize=64)
    end
end
